...
const clickApproved=(id)=>{
    ...
    return (
      <div className="lg:p-10 p-4">
                     <ToastContainer/>
            <h2 className="text-3xl text-red-500">| Manage Product</h2>
            <ul className="">
        {
...
<p><small className="font-medium text-yellow-600">Mileage {product.mileage}</small></p>
<small>{product.horsepower} HP</small>
    </div>
    <div>
        <h2 className="text-indigo-700  font-medium uppercase">Fuel : {product.fuel}</h2>
       <p> {product.economy} KMPL</p>
    </div>
    <div className=''>
